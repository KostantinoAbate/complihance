...
use KostantinoAbate\Complihance\Services\Rendering\ConsentModeRenderer;
...
class ComplihanceServiceProvider extends PackageServiceProvider
{
    public function packageBooted(): void
    {
        $this->publishes([
            ...
            __DIR__.'/../resources/data/technologies.json' => resource_path('vendor/complihance/technologies.json'),
